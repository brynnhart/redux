export const config = {
    ...
    dragonHp: Number(process.env.LORD_DRAGON_HP ?? '900'),
    dragonAttackMin: Number(process.env.LORD_DRAGON_ATTACK_MIN ?? '26'),
    dragonAttackMax: Number(process.env.LORD_DRAGON_ATTACK_MAX ?? '74'),
    dragonDefense: Number(process.env.LORD_DRAGON_DEFENSE ?? '18'),
    dragonMissChance: Number(process.env.LORD_DRAGON_MISS_CHANCE ?? '0.08'),
    playerMissChance: Number(process.env.LORD_PLAYER_MISS_CHANCE ?? '0.12'),
    pvpFleeFailChance: Number(process.env.LORD_PVP_FLEE_FAIL_CHANCE ?? '0.35'),
    pvpFleePunishMultMin: Number(process.env.LORD_PVP_FLEE_PUNISH_MULT_MIN ?? '0.6'),
    pvpFleePunishMultMax: Number(process.env.LORD_PVP_FLEE_PUNISH_MULT_MAX ?? '1.1'),
    pvpStealMinPct: Number(process.env.LORD_PVP_STEAL_MIN_PCT ?? '0.08'),
    pvpStealMaxPct: Number(process.env.LORD_PVP_STEAL_MAX_PCT ?? '0.30'),
    dragonCritChance: Number(process.env.LORD_DRAGON_CRIT_CHANCE ?? '0.12'),
    dragonCritMult: Number(process.env.LORD_DRAGON_CRIT_MULT ?? '1.9'),
    dragonFairyReviveHpRatio: Number(process.env.LORD_DRAGON_FAIRY_REVIVE_HP_RATIO ?? '0.30'),
